...
while True:
    ...
    tagger_body.velocity = (keys[pg.K_d] - keys[pg.K_a]) * tagger_speed_multiplier * 100, (keys[pg.K_w] - keys[pg.K_s]) * tagger_speed_multiplier * 100
    runner_body.velocity = (keys[pg.K_RIGHT] - keys[pg.K_LEFT]) * runner_speed_multiplier * 100, (keys[pg.K_UP] - keys[pg.K_DOWN]) * runner_speed_multiplier * 100
